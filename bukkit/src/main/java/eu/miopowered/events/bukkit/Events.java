...
public class Events {
  ...
  public static <E extends Event> ExecutionTarget<E> listen(
      Class<E> eventClass, EventPriority priority) {
  ...
  public static <E> BukkitMergedExecutionTarget<E> merge(Class<E> clazz, EventPriority priority) {
  ...
  public static <E extends Event> BukkitMergedExecutionTarget<E> merge(
      Class<E> superClass, Class<? extends E>... eventClasses) {
    return merge(superClass, EventPriority.NORMAL, eventClasses);
  }

  @SafeVarargs
  public static <E extends Event> BukkitMergedExecutionTarget<E> merge(
      Class<E> superClass, EventPriority priority, Class<? extends E>... eventClasses) {
